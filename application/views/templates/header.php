...
<head>
  ...
  <link rel="stylesheet" href="<? echo base_url('assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css'); ?>">
  <!-- iCheck -->
  <link rel="stylesheet" href="<? echo base_url('assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css'); ?>">
  <!-- JQVMap -->
  <link rel="stylesheet" href="<? echo base_url('assets/plugins/jqvmap/jqvmap.min.css'); ?>">
  <!-- Theme style -->
  <link rel="stylesheet" href="<? echo base_url('assets/css/adminlte.min.css'); ?>">
  <!-- overlayScrollbars -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<? echo base_url('assets/plugins/summernote/summernote-bs4.css'); ?>">
